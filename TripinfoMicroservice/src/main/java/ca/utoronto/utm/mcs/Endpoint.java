...
public abstract class Endpoint implements HttpHandler {
  ...
  public boolean validateFields(JSONObject JSONRequest, ArrayList<String> stringFields,
      ArrayList<String> integerFields) {
    try {
      return validateFieldsHelper(JSONRequest, stringFields, String.class)
          && validateFieldsHelper(JSONRequest, integerFields, Integer.class);
  ...
  // check if fields are in JSONRequest and make sure they're of type
  // classOfFields
  private boolean validateFieldsHelper(JSONObject JSONRequest, ArrayList<String> fields, Class<?> classOfFields)
  ...
  public JSONObject sendRequest(HttpExchange r, String uri, String reqBody, String method)
